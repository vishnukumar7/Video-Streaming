...
open class CirclePageIndicator(context: Context, attrs: AttributeSet?, defStyle: Int) :
    ...
    init {
        if (!isInEditMode) {
            ...
            val defaultPageColor: Int = res.getColor(R.color.default_circle_indicator_page_color)
            val defaultFillColor: Int = res.getColor(R.color.default_circle_indicator_fill_color)
            val defaultOrientation: Int =
                res.getInteger(R.integer.default_circle_indicator_orientation)
            val defaultStrokeColor: Int =
                res.getColor(R.color.default_circle_indicator_stroke_color)
            val defaultStrokeWidth: Float =
                res.getDimension(R.dimen.default_circle_indicator_stroke_width)
            val defaultRadius: Float = res.getDimension(R.dimen.default_circle_indicator_radius)
            val defaultCentered: Boolean = res.getBoolean(R.bool.default_circle_indicator_centered)
            val defaultSnap: Boolean = res.getBoolean(R.bool.default_circle_indicator_snap)
